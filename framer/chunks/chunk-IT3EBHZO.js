...
// /:https://framerusercontent.com/modules/79UbSh2glA9i5EAXTtRu/3lZVzfp0PkkEG0gIoPf3/Text_Opacity_Letters.js
  ...
  useEffect(() => {
    ...
    style.appendChild(
      document.createTextNode(`
            @import url('https://fonts.googleapis.com/css2?family=${fontFamily.replace(/ /g, "+")}:wght@400;500;700&display=swap');
        `)
    )
...
addPropertyControls(Text_Color_Letters, {
  text: { title: "Text", type: ControlType.String, defaultValue: "Hello Text" },
  fontFamily: {
    title: "Font Family",
